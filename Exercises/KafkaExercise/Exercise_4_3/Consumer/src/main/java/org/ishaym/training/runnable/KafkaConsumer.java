...
public class KafkaConsumer implements Runnable {
    ...
    public KafkaConsumer(Consumer<Integer, Person> consumer) {
    ...
    public void run() {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            try {
                logMessages(consumer.poll(Duration.ofMillis(Constants.genInstance().
                        getConfigurations().getConsumerProperties().
