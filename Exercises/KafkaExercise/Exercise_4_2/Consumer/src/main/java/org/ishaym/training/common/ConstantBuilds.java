...
public class ConstantBuilds {
    ...
    private static Properties createConsumerPropertiesObject() throws IOException {
        ...
        properties.put("specific.avro.reader", consumerProperties.isSpecificAvroReader());
    ...
    public static Consumer<Integer, Person> buildConsumerFromConstants() throws IOException {
