...
public class Main {
    public static void main(String[] args) {
        ...
        org.apache.kafka.clients.consumer.KafkaConsumer<String, String> innerConsumer =
                new org.apache.kafka.clients.consumer.KafkaConsumer<String, String>(consumerProperties);
        ...
        org.apache.kafka.clients.consumer.KafkaConsumer<String, Identification> innerAvroConsumer =
                new org.apache.kafka.clients.consumer.KafkaConsumer<String, Identification>(avroConsumerProperties);

        KafkaConsumer<String> kafkaStringConsumer = new KafkaConsumer<String>(innerConsumer,
